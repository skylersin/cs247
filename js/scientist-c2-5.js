...
let text = ["You did it! Awesome. There may be hope after all...",
	"That actually wasn't too different from base 10 in the end. Instead of having digits 0-9 you had 0-5.",
	"With base 6 you ended up overflowing into the next digit more often that base 10, because there are fewer digits.",
	"However, we won't just be pouring liquid into different bases. We are going to need to convert some bases. Are you ready?",
	"Great! Let's crunch some numbers!"];
